...
async function checkUserIdCard() {
  ...
  if (!userIdCardReg.test(sysAdmin.idCard)) {
  ...
  <div>
    ...
    <table class="tab" cellspacing="0px">
      <tr class="ltr">
        <td>身份证号</td>
        <td>
          <input class="ipt" type="text" v-model="sysAdmin.idCard" @blur="checkUserIdCard()">
    ...
    <div style="text-align: center;">
      ...
      <table class="tab" cellspacing="0px">
        ...
        <tr class="ltr">
          <td colspan="1" class="buttonContainer">
          ...
          <td colspan="1" class="buttonContainer">
            <router-link to="/showAdminLog">
              <button id="registration">管理员<br>操作日志</button>
            </router-link>
          </td>
        </tr>
      </table>
